...
const autoClickRates = [
   ...
   { id: 2, cost: 1, rollEveryMs: 900 },
   { id: 3, cost: 1, rollEveryMs: 800 },
   { id: 4, cost: 1, rollEveryMs: 700 },
   { id: 5, cost: 1, rollEveryMs: 600 },
   { id: 6, cost: 1, rollEveryMs: 500 },
   { id: 7, cost: 1, rollEveryMs: 400 },
   { id: 8, cost: 1, rollEveryMs: 300 },
   { id: 9, cost: 1, rollEveryMs: 200 },
   { id: 10, cost: 1, rollEveryMs: 100 },
   { id: 11, cost: 1, rollEveryMs: 50 },
   { id: 12, cost: 1, rollEveryMs: 25 },
   { id: 13, cost: 1, rollEveryMs: 10 },
   { id: 14, cost: 1, rollEveryMs: 5 },
   { id: 15, cost: 1, rollEveryMs: 3 },
   { id: 16, cost: 1, rollEveryMs: 2 },
   { id: 17, cost: 1, rollEveryMs: 1 },
   { id: 18, cost: 1, rollEveryMs: 1 },
