         ...
         <header className="grid grid-cols-1 items-center gap-5 md:grid-cols-[150px,1fr]">
            ...
            <div className="flex flex-col gap-1.5">
               ...
               <div className="flex flex-wrap items-center gap-3">
                  <button
                     type="button"
                     className="cursor-pointer rounded-xl bg-linear-to-r from-cyan-400 to-teal-500 px-4 py-3 font-bold text-slate-900 transition duration-150 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-teal-500/30 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300 active:translate-y-0"
                     onClick={handleRoll}
                  >
                     Roll the D6
                  </button>
